...
API_KEY = "cHcOCC5oXMBu2PIpHY1zrpnZ"
...
API_KEYS = [
    "sk_live_nvxiPPLqreB-o-c11d89i-Qg7rwjIFgHxSW3K5JqXh8",
    "KEY_2",
    "KEY_3"
]

BASE_URL = "https://backend.miragic.ai/api/v1/virtual-try-on"
from django.contrib import messages
...
def edit_product(request, product_id):
    ...
    if request.method == 'POST':
        ...
        product.style = request.POST.get('style')
...
def recommended_products(request):
    # For now, we're just rendering a static page
    # In the future, this could be enhanced with actual product recommendations
    media_url = settings.MEDIA_URL
    return render(request, 'store/recommended_products.html', {'media_url': media_url})
